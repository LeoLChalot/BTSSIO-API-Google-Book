                ...
                <?php if (!empty($_SESSION) && ($_SESSION['role'] == 'admin')) : ?>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            ...
                            <li><a class="dropdown-item" href="http://localhost/librairie/Librairie/cURL_request.php" class="nav-link px-2 link-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
